...
@NamedQueries({
        ...
        @NamedQuery(name = "Bug.getAllByReporterName", query = "select bug from Bug bug join fetch bug.assignee assignee join fetch  bug.reporter reporter where reporter.name = :name"),
